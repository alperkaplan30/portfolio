...
<template>
  <footer class="border-t border-surface-200 dark:border-surface-800">
    <div class="container-page flex flex-col items-center justify-between gap-6 py-8 sm:flex-row">
      ...
      <div class="flex items-center gap-5">
        <a
          ...
          class="text-surface-400 transition-colors hover:text-accent dark:text-surface-500 dark:hover:text-accent"
        >
          <!-- GitHub -->
